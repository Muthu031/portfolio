      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-display font-bold uppercase tracking-wider text-text">
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 md:flex-row">
          <p className="text-xs font-mono text-textSecondary">
            &copy; {new Date().getFullYear()} MUTHUKUMARAN.S
          </p>
          <div className="flex items-center gap-4">
            <a
            ...
            <a
              href="mailto:hello@muthukumaran.dev"
              className="icon-chip hover:border-accent-teal hover:text-accent-teal transition-colors"
              aria-label="Email"
            >
